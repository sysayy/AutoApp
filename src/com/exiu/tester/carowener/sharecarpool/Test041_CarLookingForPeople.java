...
public class Test041_CarLookingForPeople extends BaseTestCase {
	/**
	 * 共享拼车 车找人 case
	 * 
	 * @throws Exception
	...
	@Test(priority = 1)
	public void 车找人() throws Exception {
		click(getId("共享拼车"));
		click(getId("车找人"));
	...
	@Test(priority = 2)
	public void 分享_车找人() throws Exception {
		click(getId("共享拼车"));
		click(getId("车找人"));
	...
	@Test(priority = 3)
	public void 删除_车找人() throws Exception {
		click(getId("共享拼车"));
		click(getId("车找人"));
	...
	public void 预约附近拼车() throws Exception {
		...
		click(getId("车找人"));
		click(getId("查看附近拼车"));
		click(findElements(getId("CarTime")).get(5));
